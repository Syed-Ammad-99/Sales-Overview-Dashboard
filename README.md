...
The data is sourced from Kaggle (an Excel extract), [see here to find it.](https://github.com/Syed-Ammad-99/Sales-Overview-Dashboard/blob/main/date%20files/SalesBudget.xlsx)
